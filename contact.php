            ...
            <section>
                <div class="container">
                  ...
                  <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="row g-4">
                            ...
                            <div class="col-md-12 wow fadeInUp" data-wow-delay=".0s">
                                ...
                                <a href="tel:+919967064755">+91 99670 64755</a><br>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <p class="col-lg-8 wow fadeInUp">Have a question, suggestion, or just want to say hi? We’re here and happy to hear from you!</p>
                        <div class="spacer-single"></div>

                        <div class="relative wow fadeInUp" data-wow-delay=".6s">
                            <form name="contactForm" id="contact_form" method="post" action="mail.php">

        ...
        <section class="service-hero">
            ...
            <div class="container">
                <div class="service-hero__content">
                    <div class="service-kicker">Residential Interiors</div>
                    <h1>Full Home Interior</h1>
                    <p>Complete home interiors planned, designed, and executed from concept to handover.</p>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p>Complete home planning for living rooms, bedrooms, kitchens, wardrobes, lighting, furniture, finishes, and site execution.</p>
                    </div>
                    <div class="col-lg-6">
                        <div class="service-panel">
                            <h3>What We Cover</h3>
                            <ul>
                            <li>End-to-end home interior design and execution</li>
                            <li>Space planning, material selection, furniture, lighting, and decor</li>
                            <li>Site coordination, finishing checks, and handover support</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-7">
                        <div class="service-step">
                            <span>01</span>
                            <p>Home requirement and lifestyle understanding</p>
                        </div>
                        <div class="service-step">
                            <span>02</span>
                            <p>Layout, design concept, material, and budget planning</p>
                        </div>
                        <div class="service-step">
                            <span>03</span>
                            <p>Turnkey execution with final styling and handover</p>
                        </div>
                    </div>
                </div>
            </div>
